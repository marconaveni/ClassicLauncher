...
Grid::Grid(std::shared_ptr<ObjectManager> objectManager)
	: positionX(0)
	, bLeft(false)
	, bRight(false)
	, lastDirection(None)
	...
	, Object(objectManager)
{
	...
	for (int i = 0; i < 10; i++)
	{
		...
		Card card;
		card.CreateCard(TextureManager::GetInstance()->GetSprite("sprite"), Vector2{ x - 120, 228 }, Rectangle{ 528, 15, 246, 270 }, i, objectManager);
