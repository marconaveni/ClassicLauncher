...
void UStar::NativePreConstruct()
{
	Super::NativePreConstruct();
	SetUpdateRatingStar(Rating);
}

UStar::UStar(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
}

void UStar::SetTextureStar(UTexture2D* TStar0, UTexture2D* TStar1 , UTexture2D* TStar2, UTexture2D* TStar3, UTexture2D* TStar4 ) {
...
void UStar::SetUpdateRatingStar(float NewValue)
{
