...
#include "ButtonCommon.generated.h"

/**
 * 
 */
UCLASS()
class CLASSICLAUNCHER_API UButtonCommon : public UBaseButton, public IMusicInterface
{
	GENERATED_BODY()
...
protected:
	...
	UButtonCommon(const FObjectInitializer& ObjectInitializer);
